                ...
                <div class="col">
                    <div class="input-group ">
                        ...
                        <input type="text" class="form-control" name="nif_cif" placeholder="Nº Documento"
                            aria-label="Nº Documento" aria-describedby="basic-addon1" value="{{ $task['nif_cif'] ?? null }}"
                            {{ !Utils::isAdmin() ? 'readonly' : '' }}>
                    </div>
                    {{-- Error NIF --}}
                ...
                <div class="col">
                    <div class="input-group ">
                        ...
                        <input type="tel" class="form-control" name="phoneNumber" placeholder="Numero de telefono"
                            ...
                            value="{{ $task['phoneNumber'] ?? null }}" {{ !Utils::isAdmin() ? 'readonly' : '' }}>
                    </div>
                    {{-- Error phone --}}
                ...
                <div class="col">
                    <select class="form-select" name="province_id" aria-label="Default select example">
                        @foreach ($listProvinces as $key => $value)
                            @if ($key < 10)
                                <option {{ $task['province_id'] == $key ? 'selected' : '' }}
                                    {{ !Utils::isAdmin() && $task['province_id'] != $key ? 'disabled' : '' }}
                                    value="0{{ $key }}">
                                    {{ $value }}</option>
                            @else
                                <option {{ $task['province_id'] == $key ? 'selected' : '' }}
                ...
                <div class="col">
                    <div class="input-group ">
                        ...
                        <input type="text" class="form-control" name="location" placeholder="Localidad"
                            ...
                            value="{{ $task['location'] ?? null }}" {{ !Utils::isAdmin() ? 'readonly' : '' }}>
                    </div>
                    {{-- Error location --}}
                    ...
                    <div class="input-group">
                        <span class="input-group-text" id="basic-addon1"><i
                            ...
                            @foreach ($operarios as $key => $value)
                                <option {{ $task['operario'] == $key ? 'selected' : '' }}
                                    {{ !Utils::isAdmin() && $task['operario'] != $key ? 'disabled' : '' }}
                                    value="{{ $key }}">
                                    {{ $value }}</option>
                            @endforeach
                        </select>
